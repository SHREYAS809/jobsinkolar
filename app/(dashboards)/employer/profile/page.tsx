                ...
                <div className="w-full lg:w-80 space-y-8">
                    <div className="glass-panel p-2 rounded-[3.5rem] border border-white/10 shadow-2xl overflow-hidden">
                        <div className="bg-slate-950/80 backdrop-blur-3xl p-8 flex flex-col items-center text-center">
                            ...
                            <p className="text-[10px] font-black text-slate-500 uppercase tracking-[0.3em] mb-8">Strategic Entity</p>
                    ...
                    <div className="glass-panel p-8 rounded-[3rem] border border-white/5 space-y-6">
                        <div className="flex items-center gap-4 text-slate-400 font-bold text-xs uppercase tracking-widest">
                            <Globe size={16} className="text-indigo-500" /> nexus-kolar.io
                        </div>
                        <div className="flex items-center gap-4 text-slate-400 font-bold text-xs uppercase tracking-widest">
                            <MapPin size={16} className="text-indigo-500" /> Industrial Hub A1
                        </div>
                        <div className="flex items-center gap-4 text-slate-400 font-bold text-xs uppercase tracking-widest">
                            <Mail size={16} className="text-indigo-500" /> entity@nexus.co
                        </div>
                    </div>
                </div>
                ...
                <div className="flex-1 space-y-10">
                    <div className="glass-panel p-12 rounded-[4rem] border border-white/5 space-y-8">
                        <div className="flex justify-between items-center border-b border-white/5 pb-8">
                            ...
                            <Button variant="ghost" className="text-indigo-400 hover:text-white hover:bg-indigo-600/10 h-10 px-4 rounded-xl border border-indigo-500/20 text-[10px] font-black uppercase tracking-widest gap-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="glass-panel p-10 rounded-[3rem] border border-white/5 bg-indigo-600/5 group">
                            ...
                            <p className="text-2xl font-black text-white mb-2">42 Active</p>
                            <p className="text-[9px] text-slate-500 font-black uppercase tracking-widest">Open Vacancy Allocations</p>
                        </div>
                        <div className="glass-panel p-10 rounded-[3rem] border border-white/5 group">
                            ...
                            <p className="text-2xl font-black text-white mb-2">Elite Tier</p>
                            <p className="text-[9px] text-slate-500 font-black uppercase tracking-widest">Verified District Status</p>
                        </div>
                    </div>
                </div>
            </div>
