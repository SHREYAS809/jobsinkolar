                ...
                <div className="lg:col-span-2 space-y-8">
                    <div className="glass-panel p-10 rounded-[3rem] border border-white/5 space-y-8">
                        <div className="flex justify-between items-center border-b-2 border-white/20 pb-6">
                            ...
                            <Button variant="ghost" className="h-10 w-10 p-0 hover:bg-white/20 text-blue-400 border border-white/10 rounded-lg"><Edit3 size={18} /></Button>
                        </div>
                        <div className="space-y-4">
                            <div className="h-12 w-full bg-white/10 rounded-xl border-2 border-white/20 flex items-center px-4 font-black text-sm text-white shadow-inner">Rahul Sharma</div>
                            <div className="h-12 w-full bg-white/10 rounded-xl border-2 border-white/20 flex items-center px-4 font-black text-sm text-blue-300 italic">Senior UI Designer & Protocol Specialist</div>
                        </div>
                    </div>
                    ...
                    <div className="glass-panel p-10 rounded-[3rem] border border-white/5 space-y-8">
                        <div className="flex justify-between items-center border-b-2 border-white/20 pb-6">
                            ...
                            <Button variant="ghost" className="h-10 px-4 gap-2 hover:bg-white/20 text-blue-400 text-[10px] font-black uppercase tracking-widest border-2 border-white/20 rounded-xl"><Plus size={14} /> Add Segment</Button>
                        </div>
                            ...
                            {[1, 2].map((i) => (
                                <div key={i} className="p-6 bg-white/5 rounded-[2rem] border border-white/5 group hover:border-blue-500/30 transition-all flex justify-between items-start">
                                    <div>
                                        ...
                                        <p className="text-xs font-black text-blue-300 uppercase tracking-widest mb-3">Lead UX Architect • 2021 - Present</p>
                                        <p className="text-[11px] text-white font-black leading-relaxed max-w-lg">Implementing district-wide interface protocols and streamlining talent acquisition workflows...</p>
                                    </div>
                ...
                <div className="space-y-8">
                    <div className="glass-panel p-8 rounded-[3rem] border border-white/5 bg-blue-600/5">
                        ...
                        <div className="mt-8 space-y-3">
                            <div className="flex items-center gap-3 text-[10px] font-black text-white uppercase tracking-widest bg-white/10 px-3 py-2 rounded-lg">
                            ...
                            <div className="flex items-center gap-3 text-[10px] font-black text-rose-100 bg-rose-500/20 px-3 py-2 rounded-lg uppercase tracking-widest">
                    ...
                    <div className="glass-panel p-8 rounded-[3.5rem] border border-white/5 flex flex-col items-center text-center">
                        ...
                        <p className="text-[10px] text-white font-black uppercase tracking-widest leading-loose mb-6">Let our intelligence engine refine your transmission for maximum impact in Kolar.</p>
                        <Button className="w-full bg-blue-600 hover:bg-blue-500 text-white font-black uppercase tracking-widest text-[9px] h-12 rounded-xl border-2 border-blue-400 shadow-lg shadow-blue-500/20">Execute AI Protocol</Button>
                    </div>
                </div>
            </div>
        </div>
